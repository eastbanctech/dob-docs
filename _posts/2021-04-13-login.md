...
### **If this is the first time to log in to the App, follow the following steps**

### **Click on Allow on the Location popup message**
...
### **Click on Privacy in the Setting menu bar**
...
### **Once logged in, all Inspectors will receive several popups that would request several permissions and also ask the Inspector to begin work so that their location can be reported to DCRA.**
