...
#### **To add an absence click on the + icon on the schedul**
...
#### **Go to the Schedule and click on the "Absence" Then click on "Delete Absence" Button, system shall delete the absence from the Schedule.**
